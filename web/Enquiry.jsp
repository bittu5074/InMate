                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <div class="text-center mb-5">
                            ...
                            <br>
                            <h1 class="fw-bolder">Enquiry Management</h1>
      ...
      <%
        ...
        %>
         <table align='center' border='1' width="100" style="width:100%" class="table table-striped table-dark">
            ...
            <form method="POST" action="http://localhost:8080/InMate/DeleteEnquiry?email=<%=ors.getString("Email")%>" onsubmit="return checkRemove()">
        ...
        if (result.dismiss === Swal.DismissReason.timer) {
          ...
          function reloadTable(){
                ...
                function checkRemove(){
                            if(confirm("Are you sure to remove this enquiry ?") === true)
                    return true;
                else
                    return false;
                  }
