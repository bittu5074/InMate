                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;
                       ...
                       <div class="text-center mb-5">
                            ...
                            <br>
                            <h1 class="fw-bolder">User Management</h1>
                            <p class="lead fw-normal text-muted mb-0">Please be careful while you're updating or deleting data !</p>
                        </div>
                        <div class="card mb-4">
      ...
      <%
            ...
            <tbody>
                <%
                    ...
                    <%
                        ...
                        <td><button type="submit" class="button button1" onclick="doUpdate()">Update</button></td>
            <form method="POST" action="http://localhost:8080/InMate/DeletionConfirmation?email=<%=ors.getString("Email")%>" onsubmit="return checkRemove()">
        ...
        if (result.dismiss === Swal.DismissReason.timer) {
          ...
          function reloadTable(){
              ...
              function doUpdate(){
                        Swal.fire({
                        title: 'Userdata Updation',
                        html:
                            '<form method="POST" action="CheckUpdate.jsp" id="login-form"><br>' +
                            '<div class="input-container"><i class="fa fa-envelope icon"></i><input class="input-field" type="email" name="checkemail" id="checkemail" placeholder="E-mail Address" required="true" maxlength="40"/></div>' +
                            ...
                            '<div class="input-container"><label for="name"><i class="fa fa-user icon"></i></label><input class="input-field" type="text" name="checkname" id="checkname" placeholder="Enter New Name" maxlength="40" required/></div>' +
                            '<div class="input-container"><label for="contact"><i class="fa fa-phone icon"></i></label><input class="input-field" type="tel" name="checkcontact" id="checkcontact" placeholder="Enter New Contact no." maxlength="10" required/></div>' +
                            '<input type="submit" name="signin" id="signin" class="fp-submit" value="Update"/>' +
                            '</form>',
