...
<body>
    <script>
            ...
            if(request.getParameter("bVerify")!=null)
            {
                ...
                %>
                <script>
                    location.href="http://localhost:8080/InMate/ChangePassword.jsp";
                </script>
                <%
                }
                else
                {
                       %> 
                            <script>
                    location.href="http://localhost:8080/InMate/SomethingWrong";
                            </script>               
                        <%
                }
            }
    ...
    <div class="container">
        ...
        <form name="frmOTP" method="POST" action="http://localhost:8080/InMate/requestCode.jsp">
