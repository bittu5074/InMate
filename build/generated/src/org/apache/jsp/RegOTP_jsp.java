...
public final class RegOTP_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("            ");
                ...
                if(sess == null) response.sendRedirect("http://localhost:8080/InMate/SomethingWrong");
                        vname = sess.getAttribute("rname").toString();
                        votp = sess.getAttribute("rotp").toString();
                        vemail = sess.getAttribute("remail").toString();
      ...
      out.write("\n");
      out.write("                <script>\n");
      out.write("                    location.href=\"http://localhost:8080/InMate/RegConfirm.jsp\";\n");
      out.write("                </script>\n");
      out.write("                ");
      ...
      out.write("        <form name=\"frmOTP\" method=\"POST\" action=\"http://localhost:8080/InMate/RegOTP.jsp\">\n");
