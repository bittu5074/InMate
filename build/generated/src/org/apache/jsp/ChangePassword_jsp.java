    ...
    try {
      ...
      out.write("            ");
                ...
                if(sess == null) response.sendRedirect("http://localhost:8080/InMate/SomethingWrong");
                        String mail = sess.getAttribute("fnameo").toString();
                 String password = sess.getAttribute("fpasso").toString();
            ...
            ors = (OracleResultSet)ost.executeQuery(q);
                ...
                if (count > 0){
                    ...
                    response.sendRedirect("http://localhost:8080/InMate/PassChangeFailed");
                }
                oconn.close();
