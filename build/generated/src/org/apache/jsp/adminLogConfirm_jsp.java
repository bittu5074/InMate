...
public final class adminLogConfirm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              ");
                  ...
                  String p = "select * from admin where username = ? and password = ?";
                  ost = (PreparedStatement) oconn.prepareStatement(p);
                        ...
                        if (ors.next()){
                            response.sendRedirect("http://localhost:8080/InMate/AdminDisplay.jsp");
                        } else {
                            response.sendRedirect("http://localhost:8080/InMate/AdminLoginFailed");
                        }
                        oconn.close();
