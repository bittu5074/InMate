...
public class AdminPassFailed extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("window.oncontextmenu = function () {Swal.fire('Security Alert','Right-Click and Input-Facilities are disabled for security reason.','warning')}");
            out.println("document.addEventListener('contextmenu',event => event.preventDefault());");
            out.println("</script>");
            out.println("<title>InMate | Access Denied</title>");
            out.println("<link rel=\"stylesheet\" href=\"fonts/material-icon/css/material-design-iconic-font.min.css\">");
            out.println("<link rel=\"icon\" type=\"image/x-icon\" href=\"assets/attention.png\" />");
            ...
            out.println("text: \"Admin key doesn\'t exist.\",");
            ...
            out.println("window.location = \"AdminDisplay.jsp\";");
            out.println("}");
            out.println("})");
            out.println("</script>");
            out.println("</body>");
