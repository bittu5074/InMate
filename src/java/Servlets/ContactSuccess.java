...
public class ContactSuccess extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</script>");
            out.println("<title>InMate | Success</title>");
            ...
            out.println("text: \"Thanks for contacting us. We\'ll get in touch with you within 2-3 business days.\",");
